.remove('payment-method-active');
            
            if (method === 'cash') {
                cashBtn.classList.add('payment-method-active');
                paymentNote.textContent = 'Cash payment selected';
            } else if (method === 'mpesa') {
                mpesaBtn.classList.add('payment-method-active');
