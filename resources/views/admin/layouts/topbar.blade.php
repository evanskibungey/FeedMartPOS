        ...
        <div class="flex items-center justify-between h-14 sm:h-16">
            ...
            <div class="flex items-center space-x-2 md:space-x-3">
                ...
                <a href="{{ route('pos.dashboard') }}" 
                   class="hidden sm:flex items-center space-x-2 px-3 md:px-4 py-2 bg-gradient-harvest text-white rounded-lg hover:shadow-harvest transition-all duration-200 transform hover:-translate-y-0.5 group">
                    <svg class="w-5 h-5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                    <span class="text-sm font-semibold hidden md:inline">POS</span>
                </a>
